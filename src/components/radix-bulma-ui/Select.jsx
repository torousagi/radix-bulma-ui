...
export function SelectGroup({ children, label, ...props }) {
  return (
    <RadixSelect.Group {...props}>
      {label && <RadixSelect.Label className="dropdown-item has-text-grey-light">{label}</RadixSelect.Label>}
      {children}
    </RadixSelect.Group>
  )
}
...
export function SelectSeparator({ className = '', ...props }) {
  return <RadixSelect.Separator className={`dropdown-divider ${className}`} {...props} />
}
